...
public final class CreateUserResponse extends
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
    return io.scyna.ex.user.proto.UserOuterClass.internal_static_io_scyna_user_proto_CreateUserResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.scyna.ex.user.proto.CreateUserResponse.class,
            io.scyna.ex.user.proto.CreateUserResponse.Builder.class);
  }
  ...
  public static final class Builder extends
    ...
    @java.lang.Override
    public io.scyna.ex.user.proto.CreateUserResponse getDefaultInstanceForType() {
      return io.scyna.ex.user.proto.CreateUserResponse.getDefaultInstance();
    }

    @java.lang.Override
    public io.scyna.ex.user.proto.CreateUserResponse build() {
      io.scyna.ex.user.proto.CreateUserResponse result = buildPartial();
    ...
    @java.lang.Override
    public io.scyna.ex.user.proto.CreateUserResponse buildPartial() {
      io.scyna.ex.user.proto.CreateUserResponse result = new io.scyna.ex.user.proto.CreateUserResponse(this);
      result.id_ = id_;
      onBuilt();
      return result;
    }
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.scyna.ex.user.proto.CreateUserResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.scyna.ex.user.proto.CreateUserResponse) e.getUnfinishedMessage();
  ...
  public static io.scyna.ex.user.proto.CreateUserResponse getDefaultInstance() {
